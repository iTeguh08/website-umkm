...
const PostIndex = () => {
    ...
    // Kategori unik dari tag posts
    const categories = ['Semua', ...new Set(posts.flatMap(post => 
    ...
    const filteredPosts = activeCategory === 'Semua' 
        ? posts 
        : posts.filter(post => post.tags?.some(tag => tag.title === activeCategory));
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-blue-400 to-blue-600 text-white py-24">
                ...
                <div className="relative container mx-auto px-4 text-center z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Blog & Artikel</h1>
                    <p className="text-xl text-blue-100 max-w-2xl mx-auto mb-8">
                        Temukan informasi terbaru seputar UMKM, tips bisnis, dan cerita inspiratif dari pelaku usaha.
                    </p>
                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                        <div className="md:flex">
                            <div className="md:flex-shrink-0 md:w-1/2">
                                {filteredPosts[0].photo && (
                                    <img 
                                        className="h-full w-full object-cover md:h-full md:w-full" 
                                        src={`/storage/posts/${filteredPosts[0].photo}`} 
                            ...
                            <div className="p-8">
                                <div className="uppercase tracking-wide text-sm text-blue-600 font-semibold">
                                    {filteredPosts[0].tags?.[0]?.title || 'Artikel'}
                                </div>
                                <Link 
                                    href={`/posts/${filteredPosts[0].id}`}
                                    ...
                                    <div className="flex-shrink-0">
                                        <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                                            <span className="text-blue-600 font-medium">
                                                {filteredPosts[0].user?.name?.charAt(0) || 'A'}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="ml-3">
                                        <p className="text-sm font-medium text-gray-900">
                                            {filteredPosts[0].user?.name || 'Admin'}
                                        </p>
                                        <div className="flex space-x-1 text-sm text-gray-500">
                                            <time dateTime={filteredPosts[0].created_at}>
                                                {new Date(filteredPosts[0].created_at).toLocaleDateString('id-ID', {
                                                    year: 'numeric',
                                                    month: 'long',
                                                    day: 'numeric',
                                                })}
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredPosts.slice(1).map((post) => (
                        <div key={post.id} className="group bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                            {post.photo && (
                ...
                {filteredPosts.length === 0 ? (
                    <div className="text-center py-16">
                        ...
                        <h3 className="mt-2 text-lg font-medium text-gray-900">Belum ada artikel</h3>
                        <p className="mt-1 text-gray-500">Silakan kembali lagi nanti untuk melihat artikel terbaru.</p>
                    </div>
                ) : (
                ...
                <div className="container mx-auto px-4 text-center">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <p className="text-xl text-blue-100 mb-8">
                            Daftar newsletter kami untuk mendapatkan artikel terbaru langsung ke email Anda
                        </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-600">
                                Platform informasi dan inspirasi untuk pengembangan UMKM di Indonesia.
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="/tentang-kami" className="text-gray-600 hover:text-blue-600 transition-colors">Tentang Kami</a></li>
                                <li><a href="/kebijakan-privasi" className="text-gray-600 hover:text-blue-600 transition-colors">Kebijakan Privasi</a></li>
                                <li><a href="/syarat-ketentuan" className="text-gray-600 hover:text-blue-600 transition-colors">Syarat & Ketentuan</a></li>
                                <li><a href="/kontak" className="text-gray-600 hover:text-blue-600 transition-colors">Kontak</a></li>
                            </ul>
                        </div>
                        <div>
