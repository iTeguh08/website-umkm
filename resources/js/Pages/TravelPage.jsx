...
const PackageCard = ({ title, features, price }) => (
    <div className="bg-white p-[17px] rounded-lg shadow-lg flex flex-col justify-between">
        <div>
        ...
        <div className="bg-[rgb(27,134,162)] text-white py-2 px-4 rounded">
...
const ContactItem = ({ icon, text }) => (
    <div className="flex items-center justify-start gap-3 text-[1.1rem]">
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Discover the beauty of the world with our exclusive travel packages and experiences." />
                <style>
                    {`
                    @font-face {
            ...
            <div className="min-h-screen bg-[rgb(27,134,162)]">
                <div className="max-w-[840px] mx-auto px-4 sm:px-6">
                    ...
                    <div className="relative mb-32 sm:mb-24">
                        ...
                        <div className="overflow-hidden h-[200px] sm:h-[400px] relative">
                            <img
                        ...
                        {/* White Brush Stroke with Logo */}
                        <div className="absolute top-6 sm:top-10 left-1/2 -translate-x-1/2 w-full max-w-[320px] mx-auto">
                            <div className="relative flex items-center justify-center">
                                ...
                                <div className="relative z-10 py-[22px] w-full text-center">
                                    <h1 style={{ fontFamily: "Beatcarb" }} className="text-xl tracking-[2px] sm:text-[36px] text-[#145B89] [word-spacing:0.2em]">Fauget Travel</h1>
                                </div>
                            </div>
                        </div>

                        {/* Main Text */}
                        <div className="absolute top-[35%] left-1/2 transform -translate-x-1/2 text-center text-white w-full px-4">
                            <h2 className="text-[40px] sm:text-[65px] font-bold mb-6 sm:mb-8 leading-[1.1] tracking-wide">
                                EXPLORE THE<br />
                                WORLD WITH US
                            </h2>
                        </div>
                        ...
                        <div className="absolute -bottom-24 sm:-bottom-28 left-1/2 transform -translate-x-1/2 w-full">
                            <div className="relative max-w-[900px] px-4">
                                <div className="flex justify-center items-center">
                                    {/* Left photo with orange brush and dot */}
                                    <div className="relative transform -rotate-[5deg] z-30 translate-y-[-37px] hidden sm:block mr-2">
                                        {/* Orange Dot */}
                                        <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 z-40">
                                            <img
                                                src="/dotOrange.svg"
                                                alt="Orange Dot"
                                        ...
                                        <img
                                            src="/orangeBrush.svg"
                                            alt="Orange Brush"
                                            className="absolute -bottom-10 -left-10 w-[170px] h-auto z-[-1] rotate-[10deg]"
                                        />
                                    </div>

                                    {/* Center photo with dot */}
                                    <div className="relative z-20 -mx-0 sm:-mx-4 translate-y-[-11px]">
                                        {/* Orange Dot */}
                                        <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 z-40">
                                            <img
                                                src="/dotOrange.svg"
                                    ...
                                    {/* Right photo with orange brush and dot */}
                                    <div className="relative transform rotate-[7deg] z-10 translate-y-[-40px] hidden sm:block ml-2">
                                        {/* Orange Dot */}
                                        <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 z-40">
                                            <img
                                                src="/dotOrange.svg"
                                        ...
                                        <img
                                            ...
                                            alt="Orange Brush"
                                            className="absolute -bottom-[30px] -right-14 w-[180px] h-auto z-[-1] rotate-[0deg] scale-x-[-1]"
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    {/* Tagline */}
                    <div className="text-center text-white text-xl sm:text-xl font-light mt-20 sm:mt-40 mb-12 sm:mb-16 px-4">
                        Discover, Experience, and Cherish Memories That Last a Lifetime!
                    </div>

                    {/* Package Cards */}
                    <div className="max-w-[710px] mx-auto relative z-10 px-4">
                    ...
                    <div className="bg-[#145B89] p-10 pt-32 text-white">
                        <div className="flex flex-col md:flex-row justify-between items-center max-w-[840px] mx-auto mt-5">
