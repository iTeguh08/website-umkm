// resources/js/Pages/Admin/Components/JenisUsaha.jsx
        ...
        <>
            <header className="bg-white shadow-sm">
                <div className="flex justify-between items-center px-8 py-6">
                    <h1 className="text-2xl font-semibold text-gray-900">Jenis Usaha</h1>
                    <button
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Laundry</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">10 perusahaan</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm space-x-3">
                                            ...
                                            <button
                                                onClick={() => openModal('delete', { id: 1, name: 'Laundry' })}
            ...
            <CrudModal
                ...
                onClose={closeModal}
                title={
                    modalState.type === 'create' ? 'Tambah Jenis Usaha Baru' :
                        modalState.type === 'edit' ? 'Edit Jenis Usaha' :
                            modalState.type === 'delete' ? 'Hapus Jenis Usaha' : ''
                }
            >
