                                ...
                                <div className="p-8">
                                    ...
                                    <div className="flex justify-between items-center mb-8 border-b border-gray-200 pb-6">
                                        <div>
                                            ...
                                            <p className="mt-1 text-sm text-gray-600">Update your blog post details</p>
                                        </div>
                                        <Link
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 gap-8">
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500">Update or change the cover image</p>
                                                <div className="mt-4">
                                                    <input
                                                        id="photo"
                                                        type="file"
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                                ...
                                                <p className="mt-1 text-sm text-gray-500">Add or remove tags to help readers find your post</p>
